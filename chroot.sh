...
pacman -S grub efibootmgr networkmanager network-manager-applet inotify-tools wpa_supplicant mtools dosfstools git snapper bluez bluez-utils xdg-utils alsa-utils pulseaudio pulseaudio-bluetooth base-devel linux-headers 
